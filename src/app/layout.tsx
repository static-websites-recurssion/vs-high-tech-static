...
export const metadata: Metadata = {
  ...
  description:
    "Four ISO-certified security printing in Hyderabad & Vijayawada — ISO 9001, 27001, 14001 & 20000-1 — question papers, OMR, certificates, and confidential print for AP & Telangana.",
  icons: {
    icon: [
