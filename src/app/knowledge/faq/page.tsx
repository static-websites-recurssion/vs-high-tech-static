...
const faqs = [
  ...
  {
    q: "How do you ensure question papers do not leak?",
  ...
  {
    q: "Do you serve clients outside Andhra Pradesh, Telangana, and Karnataka?",
    a: "Yes. Our main clients are in Andhra Pradesh, Telangana, and Karnataka, but we take up projects from other states as well, depending on volume, timelines, and delivery logistics.",
  },
  {
  ...
  {
    q: "How do you transport material securely?",
  ...
  {
    q: "Can you print variable data (unique codes or numbers per sheet)?",
  ...
  },
  {
    ...
    a: "We offer sixteen document security options, including Barcode, QR Code, Spelling Mistake cues, Watermark, UV Invisible Logo, Microtext, Micro Line, Invisible Sign, Thermochromic Ink, Copy Void, Fluorescent Border, Guilloche Design, Mirror Text, High Resolution Border, Relief Background, and Hologram. We help you choose the right combination for your tender.",
  },
  {
    q: "What is your turnaround time for urgent jobs?",
    a: "Turnaround depends on quantity, security features, and schedule. For urgent requirements, we can prioritise your job, since we run 365 days a year, 24×7.",
  },
  {
  ...
  {
    q: "Can clients visit your facility before placing an order?",
