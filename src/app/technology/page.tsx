...
import { MachineCategoriesAccordion } from "@/components/technology/machine-categories-accordion";

export const metadata: Metadata = {
  title: {
    absolute: "Our Printing Infrastructure | State-of-the-Art Machinery",
  },
  description:
    "Web offset, stationery, CTCP, binding, cutting, and security finishing — plus our security environment, testing labs, and Hyderabad & Vijayawada premises.",
};
      ...
      <section className="w-full bg-primary text-white">
        <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 sm:py-16 lg:px-8">
          ...
          <p className="mt-4 max-w-3xl text-lg text-white/90 sm:text-xl">
            Two fully-equipped plants in Hyderabad and Vijayawada, running 365
            days, 24 hours
          </p>
        </div>
      </section>

      {/* SECTION 2 — Machine categories */}
